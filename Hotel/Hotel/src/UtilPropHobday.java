...
public class UtilPropHobday {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/Hotel/config.properties";
